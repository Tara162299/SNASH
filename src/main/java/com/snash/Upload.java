...
public class Upload {
  ...
  public class UploadAllFilesInFolder {
    ...
    public static void main(String[] args) throws Exception {
      String directoryName = "TO BE WRITTEN"; //upload file directory
    ...
    int fileSize, byte[] fileBytes, boolean useChunkedUpload) throws IOException, InterruptedException, NoSuchAlgorithmException {
      try {
